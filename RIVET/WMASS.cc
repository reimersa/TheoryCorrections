...
namespace Rivet {
  ...
  class MC_WMASS : public Analysis {
  public:

    /// Default constructor                                                                                                                                       
    RIVET_DEFAULT_ANALYSIS_CTOR(MC_WMASS);
    ...
    void init() {
      ...
      FinalState fs;
      WFinder wfinder(fs, Cuts::abseta < 3.5 && Cuts::pT > 25*GeV, PID::MUON, 60.0*GeV, 100.0*GeV, 25.0*GeV, _dR);
